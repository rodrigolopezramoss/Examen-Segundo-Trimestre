...
public class Ex08rlr3 {
  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      System.out.println("7. Productos bajos de stock");
      ...
      switch (opcion) {
        ...
        case 1: // Listado /////////////////////////////////////////////
          ...
          for (Articulo aux : a) {
        	String p = aux.getCodigo();
        	palabritas.add(p);
          }
          
          Collections.sort(palabritas);
          
          for (String aux : palabritas) {
        	contador = 0;
        	for (Articulo aux2 : a) {
        	  if((aux2.getCodigo().equals(aux))&&(contador < 1)) {
          ...
          System.out.println("Número total de artículos: " + cuentaArticulo);
          System.out.println("Precio compra promedio: " + precom/cuentaArticulo);
          System.out.println("Precio venta promedio: " + preven/cuentaArticulo);
          System.out.println("Margen de beneficio: " + ((preven/cuentaArticulo)-(precom/cuentaArticulo)));
        ...
        case 6: // Venta
          ...
          break;
        case 7:
          System.out.print("Introduce el stock máximo para filtrar: ");
          bajo = Integer.parseInt(s.nextLine());
          System.out.println("\nARTICULOS CON UN STOCK DE " + bajo + " O MENOS\n=======");
          ...
          for (String aux : palabritas) {
          	...
          	for (Articulo aux2 : a) {
          	  if(contador < 1) {
          	    if((aux2.getCodigo().equals(aux))&&(aux2.getStock() <= bajo )) {
                  System.out.println(aux2);
                  contador++;
          	    }
          	  }
